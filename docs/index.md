...
| Part 3 | [コレクションと LINQ](part-03-collections-linq/README.md) | [レビュー観点](part-03-collections-linq/checklist.md) |
| Part 4 | [文字列・日付・ファイル・データ形式](part-04-strings-dates-files-data/README.md) | [レビュー観点](part-04-strings-dates-files-data/checklist.md) |
| Part 5 | [オブジェクト指向と設計パターン](part-05-oop-patterns/README.md) | [レビュー観点](part-05-oop-patterns/checklist.md) |
| Part 6 | [非同期・並列・外部 I/O](part-06-async-parallel-io/README.md) | [レビュー観点](part-06-async-parallel-io/checklist.md) |
| Part 7 | [実務アプリケーションの定石](part-07-application-practices/README.md) | [レビュー観点](part-07-application-practices/checklist.md) |
