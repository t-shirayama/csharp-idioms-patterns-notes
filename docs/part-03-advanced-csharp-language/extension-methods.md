...
## TODO対応: C# 14 extension members の章を追加し

> 対応元: P0 / C# 14 extension members の章を追加し、従来の extension method との使い分け、extension property を公開 API にするリスク、namespace 汚染のレビュー観点を補う。
