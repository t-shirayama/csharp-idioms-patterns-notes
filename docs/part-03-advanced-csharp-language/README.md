...
一方で、アプリケーションの業務ロジックにこれらを過剰に入れると、処理の流れが見えにくくなります。高度な言語機能は、責務の境界を明確にしたい場所で使い、単に短く書く目的だけでは使いません。
...
- [コードレビューチェックリスト](checklist.md): Part 3 の内容をレビュー時に確認できるチェックリストです。
