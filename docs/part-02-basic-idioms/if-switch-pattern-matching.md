...
## TODO対応: sealed record hierarchy による疑似 discriminate…

> 対応元: P1 / sealed record hierarchy による疑似 discriminated union、switch の網羅性、`when` guard の使いすぎ、状態追加時のテスト観点を追加する。
