...
## TODO対応: DbContext lifetime

> 対応元: P1 / `DbContext` lifetime、thread safety、connection pooling、retry / execution strategy、command timeout、split query を追加する。
...
> 対応元: P2 / raw SQL、bulk update/delete、tenant 境界、監査項目更新漏れの例を追加する。
